...
#include "libbase/parsenetaddress.h"

#include <algorithm>

#include "libbase/stringprintf.h"
#include "libbase/strings.h"

namespace libbase {

bool ParseNetAddress(
    const std::string &address, std::string *host, int *port, std::string *canonical_address, std::string *error) {
    host->clear();
